...
인스턴스 109에서 세 정책의 헤드 카메라. 동일 조건·동일 시작 상태이며, 에피소드 전체를 압축했다.
...
| 테이블로 접근해 라디오를 조작 | 라디오까지는 도달하나 조작 실패 | 다른 방을 배회, 대상에 접근조차 못 함 |
| 2580 step 종료 | 4300 step 타임아웃 | 4300 step 타임아웃 |
